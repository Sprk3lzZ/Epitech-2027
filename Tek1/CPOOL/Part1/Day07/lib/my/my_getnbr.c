...
unsigned int get_first_digit_position(char const *str)
{
...
unsigned int get_digit_count(char const *str)
{
...
char test_overflow(char const *str, int sign)
{
    char *max = "2147483648";
...
unsigned int get_sign_count(char const *str)
{
